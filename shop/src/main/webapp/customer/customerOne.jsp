...
<div class = "container" style="text-align: center">
	...
	<div class = "container" style="display: inline-block;  width:70%">	<br>
	<h2>회원정보</h2>	
		<hr>
		...
		%>	
			<form class="form-control" style="margin-bottom : 50px;  border:solid 2px">
			...
			<div style="text-align:left;">
				...
				<table style="width:100%;  text-align:left">
					<tr>
						...
						<td rowspan="3" style="text-align:center; padding: 10px 10px; border-left:1px solid; height:250px; width:15%;"> 
				<%
				...
				%>		
						<a href="#" class="btn btn-warning" style="margin:10px 0px;">배송조회</a> <br>
						
						
				<%
					if( m.get("state").equals("배송완료")){
				%>			
					<a href="/shop/goods/goodsOne.jsp?goodsNum=<%=m.get("goodsNum")%>" class="btn btn-info">리뷰작성</a> <br>
				...
				%>			
					<a href="/shop/action/deleteOrderAction.jsp?orderNum=<%=m.get("orderNum")%>" class="btn btn-danger">주문취소</a>
